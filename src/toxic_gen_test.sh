...
# reset_cuda
CUDA_VISIBLE_DEVICES=$DEVICE python3 toxic_gen_test.py -model $model -dataset $dataset -classes $n_classes -method pdr_tuning -forget_perc $forget_perc -model_path $model_path -seed $seed -b $batch_size
reset_cuda
